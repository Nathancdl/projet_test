document.addEventListener("DOMContentLoaded", e => {
    ...
    let getLikeNum = document.getElementsByClassName('vote')

    let myButtonDislike = document.querySelector('#my-button-dislike');
    let getDislikeNum = document.querySelector('#countdislike')
    ...
    myButtonDislike.addEventListener('click', function (event) {
